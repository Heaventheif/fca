...
import {
  ...
  getMqttReconnectDelay as z,
} from '../../safety/stealth-profiles.js';
import {
  createSessionSeed as _sessionSeed,
  AdaptivePinger as _APinger,
...
function X(S) {
  ...
  return d(function W(I, p, e, c) {
    ...
    function _(i) {
      const o = typeof i == 'number' ? i : z(e._reconnectAttempts);
    ...
    const b = F(e),
      h = {
        ...
        keepalive: _sessionSeed().mqttKeepalive || 55,
        reschedulePings: !1,
        reconnectPeriod: 0,
        connectTimeout: 12e3,
      };
    ...
    function L() {
      u();
      _adPinger = new _APinger(() => {
        try {
          n && n.connected && typeof n.ping == 'function' && n.ping();
        } catch {}
      });
      _adPinger.start();
    }
