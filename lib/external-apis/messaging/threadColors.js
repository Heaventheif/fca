...
var r = (e, a) => n(e, 'name', { value: a, configurable: !0 });
function l(e, a, o) {
  return {
...
export const $plugin = {
  name: 'fca-external-apis-messaging-thread-colors',
  meta: { category: 'external-api-messaging', path: 'lib/external-apis/messaging/threadColors.js' },
  setup(_ctx) {
    // see module exports
  },
};
