...
var l = (t, p) => d(t, 'name', { value: p, configurable: !0 });
import n from '../../../lib/utils/compat-utils.js';
function h(t, p, e) {
  return l(function (r, a) {
    let i;
    const f = new Promise(function (o, c) {
      i = l((u, s) => (u ? c(u) : o(s)), 'cb');
    });
    if (
      ...
      t.postFormData('https://www.facebook.com/profile/picture/upload/', e.jar, {
        profile_id: e.userID,
        photo_source: 57,
        av: e.userID,
        file: r,
      })
        .then(n.parseAndCheckLogin(e, t))
        .then(function (o) {
          if (o.error || o.errors || !o.payload) throw o;
          const c = {
            input: {
          ...
          return t
            .post('https://www.facebook.com/api/graphql', e.jar, {
        ...
        .then(function (o) {
          if (o.errors) throw o;
          return i(null, o.data.user_update_cover_photo.user.cover_photo.photo.url);
        })
        .catch(function (o) {
          return (n.error('changeCover', o), i(o));
        });
    else {
      const o = 'image should be a readable stream, not ' + n.getType(r);
      (n.error('changeCover', o), i(o));
    }
    return f;
  }, 'changeCover');
}
...
export const $plugin = {
  name: 'fca-external-apis-action-change-cover',
  meta: { category: 'external-api-action', path: 'lib/external-apis/action/changeCover.js' },
  setup(_ctx) {
    // see module exports
  },
};
